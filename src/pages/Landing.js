    ...
    return (
        <div id='landing'>
            ...
            <div class="header">
                ...
                <button id='sign-up' onClick={handle}>Sign Up</button>
            </div>
            <div class="marquee">
                <span>
            ...
            <section>
                <img src='https://cdn3d.iconscout.com/3d/free/thumb/netflix-2950136-2447898.png' data-speed="-2" className='layer netflix' />
                <img src='https://clouddevs.com/3dbay/files/preview/960x960/11653407779f7hrmbpckskwtmizpwffnsxehxfwhd5hvlrpyxagqeddhv3hgj249h0iamgayaqhkqpim3cbhp4iepg5ktskbgvi8r8bxffih6lg.png' data-speed="1" className='layer adobe' />
                <img src='https://cdn3d.iconscout.com/3d/free/thumb/tinder-2950146-2447907.png' data-speed="2" className='layer tinder' />
                <img src='https://cdn3d.iconscout.com/3d/free/thumb/youtube-2950143-2447893.png?f=webp' data-speed="-1" className='layer youtube' />
            </section>
            {
                AddLibrary('parallax.js')
            }
        </div>
    )
}
